...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) {
  ...
  if ($stmt->execute()) {
    header("Location: tablesdata.php?message=deleted"); // Redirect after deletion
    exit;
  } else {
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            ?>
              <a href="insert_navbar.php" class="btn btn-success px-3">
                add
              </a>
              <!-- Default Table -->
                ...
                <tbody>
                  ...
                  foreach ($databases as $datab) {
                    echo " <tr>";
                      ...
                      echo "<td>";
                      echo '<form action="tablesdata.php" method="POST" class=" d-flex gap-2">';
                      echo '<a href="view_navbar.php?id=' . htmlspecialchars($datab['id']) . '" class="btn btn-primary"><i class="fa-regular fa-eye fa-sm "></i><span>View</span></a>';                    echo '<a href="edit_navbar.php?id=' . htmlspecialchars($datab['id']) . '" class="btn btn-warning"><i class="fa-solid fa-pen-to-square fa-sm"></i><span>Edit</span></a>';
                      echo '<form action="tablesdata.php" method="POST" style="display:inline;">';
