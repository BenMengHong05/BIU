...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) {
    ...
    if ($stmt->execute()) {
        header("Location: trend_table.php?message=deleted"); // Redirect after deletion
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            ?>
                            <a href="trend_add.php" class="btn btn-success px-3">Add</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($databases as $datab) {
                                        ...
                                        echo '<div class="d-flex gap-2">';
                                            echo '<a href="trend_view.php?id=' . htmlspecialchars($datab['id']) . '" class="btn btn-primary"><i class="fa-regular fa-eye fa-sm"></i> View</a>';
                                            echo '<a href="trend_edit.php?id=' . htmlspecialchars($datab['id']) . '" class="btn btn-warning"><i class="fa-solid fa-pen-to-square fa-sm"></i> Edit</a>';
                                            echo '<form action="trend_table.php" method="POST"  style="display:inline;">';
