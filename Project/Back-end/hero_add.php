                    ...
                    if (isset($_POST['title'], $_POST['description'], $_FILES['image'])) {
                        ...
                        if ($image['error'] === UPLOAD_ERR_OK) {
                            ...
                            if (move_uploaded_file($image['tmp_name'], $uploadFile)) {
                                $sql = "INSERT INTO hero (title, description, image) VALUES (:title, :description, :image)";
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <textarea class="form-control mt-2" id="description" name="description" required></textarea>
