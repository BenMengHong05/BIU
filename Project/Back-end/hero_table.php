...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) {
    ...
    if ($stmt->execute()) {
        header("Location: hero_table.php?message=deleted"); // Redirect after deletion
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            ?>
                            <a href="hero_add.php" class="btn btn-success px-3">Add</a>
                            ...
                            <table class="table mt-2">
                                ...
                                <tbody>
                                    ...
                                    foreach ($databases as $datab) {
                                        ...
                                        echo "<td>" . htmlspecialchars($datab['description']) . "</td>";
                                        echo '<td><img clas="image-fluid " src="image/' . htmlspecialchars($datab['image']) . '" width="100"></td>';
                                        echo '<td> ';
                                            echo '<div>';
                                            echo '<a href="hero_view.php?id=' . htmlspecialchars($datab['id']) . '" class="btn btn-primary"><i class="fa-regular fa-eye fa-sm"></i> View</a>';
                                            echo '<a href="hero_edit.php?id=' . htmlspecialchars($datab['id']) . '" class="btn btn-warning"><i class="fa-solid fa-pen-to-square fa-sm"></i> Edit</a>';
                                            echo '<form action="hero_table.php" method="POST"  style="display:inline;">';
