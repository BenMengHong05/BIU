...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) {
    ...
    // Delete query
    $sql = "DELETE FROM discounds WHERE id = :id";
    $stmt = $pdo->prepare($sql);
    $stmt->bindParam(':id', $id, PDO::PARAM_INT);

    if ($stmt->execute()) {
        header("Location: discound_table.php?message=deleted"); // Redirect after deletion
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            ?>
                            <a href="discound_add.php" class="btn btn-success px-3">Add</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($databases as $datab) {
                                        ...
                                        echo '<div class="d-flex gap-2">';
                                            echo '<a href="discound_view.php?id=' . htmlspecialchars($datab['id']) . '" class="btn btn-primary"><i class="fa-regular fa-eye fa-sm"></i> View</a>';
                                            echo '<a href="discound_edit.php?id=' . htmlspecialchars($datab['id']) . '" class="btn btn-warning"><i class="fa-solid fa-pen-to-square fa-sm"></i> Edit</a>';
                                            echo '<form action="discound_table.php" method="POST"  style="display:inline;">';
